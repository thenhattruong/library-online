...
if (isset($_POST)) {
    ...
    try {
        ...
        $to = "m2103libraryonline@gmail.com";
        $to_name = "Quản trị viên M2103";
        ...
        $noidungthu = ' <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text"> Hãy trả lời tôi qua sdt này :' . $_POST['phone'] . '</p>
                    <p class="card-text"> Hãy trả lời tôi qua email này :' . $_POST['email'] . '</p>
