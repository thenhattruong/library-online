                ...
                <div class="col-md-8 blog-body"> 
                     ...
                     ?>
                            ...
                            <div class="blog-post"> 
                                ...
                                <a href="index.php?q=bookdetails&id=<?php echo $result->IBSN;?>" class="btn btn-primary">Đọc thêm <i class="fa fa-angle-right"></i></a>
                            </div>
                            <!-- End Blog Post -->
                    ...
                    <?php if ($maxrow > 0) { ?>
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="index.php?q=books&category=<?php echo $category;?>&page=1">Đầu</a></li>
                        <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                            <a class="page-link" href="<?php if($page <= 1){ echo '#'; } else { echo "index.php?q=books&category=".$category."&page=".($page - 1); } ?>">Trước</a>
                        </li>
                        <li class="page-item <?php if($page >= $total_pages){ echo 'disabled'; } ?>">
                            <a class="page-link" href="<?php if($page >= $total_pages){ echo '#'; } else { echo "index.php?q=books&category=".$category."&page=".($page + 1); } ?>">Sau</a>
                        </li>
                        <li class="page-item"><a class="page-link" href="index.php?q=books&category=<?php echo $category;?>&page=<?php echo $total_pages; ?>">Cuối</a></li>
                    </ul>
                    <?php }else{ echo '<h1>Không tìm thấy sách trong thư viện!</h1>';} ?> 
                    </nav>
                    <!-- 
                    <nav>
                        <ul class="pagination">
