...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="<?php echo web_root;?>admin/">Trang quản lý</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="<?php echo web_root;?>admin/users/index.php?view=view&id=<?php echo $_SESSION['USERID']?>">Thông tin</a> 
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo web_root;?>admin/logout.php">Đăng xuất</a>
                    </div>
                </li>
            </ul>
        </nav>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">Cốt lõi</div>
                            ...
                            <div class="sb-sidenav-menu-heading">Giao dịch</div>
                                ...
                                Sách trả</a>
                               <div class="sb-sidenav-menu-heading">Giao diện người dùng</div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright to M2103-TEAM©</div>
                            <div>
