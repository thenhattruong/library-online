		  ...
		  <form class="form-horizontal span4" action="#.php" method="POST" autocomplete="off">
					...
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-filter"></span>Tuỳ chọn truy vấn</h3>
					    <hr/>
					  </div>
				                ...
				                <div class="col-md-10">
							         <div class="btn-group">
									    ...
									    <button type="Reset" name="search" class="btn btn-info"><i class="fa fa-refresh"></i> Reset</button> 
									     <a href="index.php" class="btn btn-success  "><i class="fa fa-arrow-left"></i> Trở về</a> 
...
<?php }else { ?>
	...
	<div class="searchagain"> 
		<a href=""><i class="fa fa-arrow-left"></i> Tìm lại</a> 
	</div>  
			  ...
			  // 		echo '<tr>';  
				...
				echo '<div class="layer">
						<a href="">
							...
							<div class="desc">IBSN : ' . $result->IBSN.' ... '.  $result->BookDesc.' ... '.  $result->Category.'<br/>Tác giả : '. $result->Author.'</div>
						</a>
					</div>'; 
