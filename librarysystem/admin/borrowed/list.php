            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Danh Sách Mượn Sách 
							...
							foreach ($cur as $result) {
								...
								if ($_SESSION['TYPE']=="SystemAdministrator" || $_SESSION['TYPE']=="Administrator") {
									...
									if ($result->Status=='Confirmed') {
										# code...
										$button = '<a title="Edit" href="controller.php?action=return&id='.$result->TransactionID.'" class="btn btn-primary btn-sm  " ><i class="fa fa-check"></i> Trả lại</a>';
									}elseif($result->Status=='Pending'){
										$button = '<a title="Edit" href="controller.php?action=confirm&id='.$result->TransactionID.'" class="btn btn-primary btn-sm  " ><i class="fa fa-check"></i> Xác nhận</a>';
									}
				  			# code...
						  			$btn= '
						  			<a title="View Book Details" href="index.php?view=view&id='.$result->TransactionID.'" class="btn btn-info btn-sm  " ><i class="fa fa-info"></i> Xem</a> 
						  			  		'.$button.'
						  					 <a title="Delete" href="controller.php?action=cancel&id='.$result->TransactionID.'&" class="btn btn-danger btn-sm  " ><i class="fa fa-times"></i> Huỷ bỏ</a>';
