     ...
     <form class="form-horizontal span6" action="controller.php?action=add" method="POST" autocomplete="off">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="CATEGORY" name="CATEGORY"  type="text" value="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "DDecimal">Dewey Decimal:</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="DDecimal" name="DDecimal"  type="text" value="">
                      </div>
                    </div>
                  </div>
