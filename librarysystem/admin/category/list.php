...
?>
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Danh mục thể loại 
				  ...
				  <tbody>
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td align="center"><a title="Edit" href="index.php?view=edit&id='.$result->CategoryId.'" class="btn btn-primary btn-sm  ">  <span class="fa fa-edit fw-fa"></span> Sửa</a>
				  		     <a title="Delete" href="controller.php?action=delete&id='.$result->CategoryId.'" class="btn btn-danger btn-sm  ">  <span class="fa  fa-trash fw-fa "></span> Xoá</a></td>';
				  		 }else{
