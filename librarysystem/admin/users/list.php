...
?>   
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Danh sách <a href="index.php?view=add" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Mới</a></h6>
            </div>
            <div class="card-body">
				  	...
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		if ($result->TYPE=="SystemAdministrator") {
				  			...
				  			$btn= '<a title="Edit" href="index.php?view=edit&id='.$result->USERID.'" class="btn btn-primary btn-sm  " ><i class="fa fa-edit"></i> Sửa</a> <a title="Edit" href="index.php?view=changepassword&id='.$result->USERID.'" class="btn btn-success btn-sm  " ><i class="fa fa-lock"></i> Đổi mật khẩu</a> <a title="View" href="index.php?view=view&id='.$result->USERID.'" class="btn btn-info btn-sm  " ><i class="fa fa-edit"></i> Xem</a>
				  					 <a title="Delete" href="controller.php?action=delete&id='.$result->USERID.'" class="btn btn-danger btn-sm  " ><i class="fa fa-trash"></i> Xoá</a>';
				  		}
				  		echo '<td > '.$btn.'</td>';
				  		echo '</tr>';
				  	} 
